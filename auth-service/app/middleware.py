"""Correlation + security middleware for the Auth service.

Reads the gateway-propagated X-Correlation-ID (or mints one) so every log line in a
request carries it, and applies baseline security headers.

(Mirrors the gateway's middleware; consolidating these into echoscope_common is

"""Auth dependency: trust the gateway-injected X-User-* headers.

The API gateway validates the JWT and forwards user context as X-User-Id / X-Role /
X-Org-Id (it strips the raw Authorization header). Downstream services like this one
trust those headers for org scoping and RBAC.
"""
